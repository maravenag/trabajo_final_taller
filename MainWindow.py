...
#
# Created: Tue Jul  8 16:19:19 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabla_animal.setGeometry(QtCore.QRect(160, 20, 241, 351))
        ...
        self.widget.setGeometry(QtCore.QRect(10, 450, 210, 88))
        ...
        self.widget1.setGeometry(QtCore.QRect(230, 450, 561, 88))
        self.widget1.setObjectName("widget1")
        self.verticalLayout = QtGui.QVBoxLayout(self.widget1)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.lbl_cant_ani = QtGui.QLabel(self.widget1)
        ...
        self.widget2.setGeometry(QtCore.QRect(20, 390, 381, 31))
        self.widget2.setObjectName("widget2")
        self.horizontalLayout_2 = QtGui.QHBoxLayout(self.widget2)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.btn_editar_tipo = QtGui.QPushButton(self.widget2)
        ...
        self.btn_agregar_animal = QtGui.QPushButton(self.widget2)
        self.btn_agregar_animal.setObjectName("btn_agregar_animal")
        self.horizontalLayout.addWidget(self.btn_agregar_animal)
        self.btn_editar_animal = QtGui.QPushButton(self.widget2)
        self.btn_editar_animal.setObjectName("btn_editar_animal")
        self.horizontalLayout.addWidget(self.btn_editar_animal)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_cant_ani.setText(QtGui.QApplication.translate("MainWindow", "TextLabel", None, QtGui.QApplication.UnicodeUTF8))
